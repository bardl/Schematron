...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA SETUP-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="Norsk purring til UBL"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">NONATUBL-T17</xsl:attribute>
            <xsl:attribute name="name">NONATUBL-T17</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Norsk purring til UBL</svrl:text>

   <!--PATTERN NONATUBL-T17-->


	<!--RULE -->
<xsl:template match="//cac:AccountingCustomerParty/cac:Party" priority="1007" mode="M5">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:ReminderLine" priority="1006" mode="M5">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cbc:ProfileID" priority="1005" mode="M5">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test=". = 'urn:www.cenbii.eu:profile:bii08:ver1.0'">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="/ubl:Reminder" priority="1004" mode="M5">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:AccountingSupplierParty/cac:Party" priority="1003" mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:TaxSubtotal" priority="1002" mode="M5">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/ubl:Reminder/cac:TaxTotal" priority="1001" mode="M5">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:LegalMonetaryTotal" priority="1000" mode="M5">
