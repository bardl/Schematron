...
public class XMLWriter extends XMLFilterImpl
{
     ...
     * document.</p>
     *
     * @throws IOException when error occurs during flush
     * @see #reset
     */
     ...
     * {@link #emptyElement(String, String, String, org.xml.sax.Attributes)}
     * directly.</p>
     *
     * @param uri The element's Namespace URI.
     * @param localName The element's local name.
     ...
     *            writing the empty tag, or if a handler further down
     *            the filter chain raises an exception.
     * @see #emptyElement(String, String, String, org.xml.sax.Attributes)
     */
     ...
     * {@link #startElement(String, String, String, org.xml.sax.Attributes)},
     * followed by
